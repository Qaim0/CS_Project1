...
• Radius: 695,700km
• Temperature: 5,973 to 15,000,00C
...
• Radius: 2, 439km
• Average Temperature: 167C
• Maximum distance from the sun: 46, 000, 000km
• Satellites: 0
...
• Maximum distance from the sun: 109, 000, 000km
• Satellites: 0
• Age: 4.503 billion years
...
• Maximum distance from the sun: 146, 000, 000km
• Satellites: The Moon
...
• Equator circumference: 15,329km
• Radius: 3392km
• Average Temperature: -65C
• Maximum distance from the sun: 205,000,000km
...
• Radius: 71, 400km
• Average Temperature: -110C
• Maximum distance from the sun: 817, 000, 000km
• Satellites: 79 known
• Age: 4.603 billion years
...
• Equator circumference: 15, 329km
• Radius: 59, 936km
• Average Temperature: -140C
• Maximum distance from the sun: 1.5 billion km
• Satellites: 82 known moons
• Age: 4.503 billion years
...
With a radius of 36,183.7 miles (58,232 kilometres), Saturn is 9 times wider than Earth. 

From an average distance of 886 million miles (1.4 billion kilometres), Saturn is 9.5 astronomical units away from the Sun. One astronomical unit (abbreviated as AU) is the distance from the Sun to Earth. From this distance, it takes sunlight 80 minutes to travel from the Sun to Saturn.

Saturn is home to a vast array of moons including the famous titan and Phoebe.
'''
uranus_info = '''
                           URANUS
...
• Equator circumference: 15, 329km
• Radius: 25, 744km
• Average Temperature: -195C
• Maximum distance from the sun: 3 billion km
...
• Maximum distance from the sun: 4.54 billion km
...
With a radius of 15,299.4 miles (24,622 kilometres), Neptune is about four times wider than Earth. From an average distance of 2.8 billion miles (4.5 billion kilometres), Neptune is 30 astronomical units away from the Sun. One astronomical unit (abbreviated as AU) is the distance from the Sun to Earth. From this distance, it takes sunlight 4 hours to travel from the Sun to Neptune.
'''
system_info = '''

                         THE SOLAR SYSTEM 

The planetary system we call home is in an outer spiral arm of the Milky Way galaxy.
